...
디버깅이란? 실행을 했을 때 내가 원하는 결과가 나오지 않을때 한줄씩 

주피터 랩은 데이터 분석,머신러닝....에서 사용함
...
- 변수란? 컴퓨터 메모리(Ram) 어딘가에 저장되어 있는 객체를 참조하기 위해 사용되는 이름 ->  box
...
박스가 붙어있는거 컴퓨터 언어는 0부터 센다는거 주의하기!
